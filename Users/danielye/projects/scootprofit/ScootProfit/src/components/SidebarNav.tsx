...
import { SidebarMenuItem, SidebarMenuButton, SidebarGroup, SidebarGroupContent } from '@/components/ui/sidebar';
...
export function SidebarNav() {
  ...
  return (
    <SidebarGroup>
        <SidebarGroupContent>
            {navItems.map((item) => {
                const isActive = pathname === '/' ? item.href === '/dashboard' : pathname.startsWith(item.href);
